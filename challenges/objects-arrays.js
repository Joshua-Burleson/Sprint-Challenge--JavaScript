...
*/
  // Easier ways to do this, 1 of 2: create a class
class Dinosaur{
  ...
  // Easier ways to do this, 2 of 2: create a function which returns an object

const dinoGen = (name, diet, weight, length, period) => {
  return {
    name,
    diet,
    weight,
...
const funkyRex = dinoGen("tyrannosaurus", "carnivorous", "7000kg", "12m", "Late Cretaceous");
...
const classySteg = new Dinosaur("stegosaurus", "herbivorous", "2000kg", "9m", "Late Jurassic");

const funkySteg = dinoGen("stegosaurus", "herbivorous", "2000kg", "9m", "Late Jurassic");
...
const classyCleverGirl = new Dinosaur("velociraptor", "carnivorous", "15kg", "1.8m", "Late Cretaceous");

const funkyCleverGirl = dinoGen("velociraptor", "carnivorous", "15kg", "1.8m", "Late Cretaceous");

const basicCleverGirl = {
  name: "velociraptor",
  diet: "carnivorous",
  weight: "15kg",
  length: "1.8m",
...
console.log(basicRex.weight);
console.log(classyRex.weight);
console.log(funkyRex.weight);

// What was the diet of a velociraptor?
console.log(basicCleverGirl.diet);
console.log(classyCleverGirl.diet);
console.log(funkyCleverGirl.diet);

// How long was a stegosaurus?
console.log(basicSteg.length);
console.log(classySteg.length);
console.log(funkySteg.length);

// What time period did tyrannosaurus live in?
console.log(basicRex.period);
console.log(classyRex.period);
console.log(funkyRex.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.

basicRex.roar = () =>  "RAWERSRARARWERSARARARRRR!";

console.log(basicRex.roar());
...
const unisWithUni = graduates.filter(grad => grad.university.match(/Uni/));
...
Using filter, create a new array of objects called lowPopulationAnimals which contains only the animals 
...
Find the total population from all the zoos using the .reduce() method. Remember the reduce method takes two arguments: 
